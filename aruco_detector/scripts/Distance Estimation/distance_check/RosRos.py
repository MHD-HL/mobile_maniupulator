...
def main():
    ...
    pub = rospy.Publisher("/aruco_pose", PoseStamped,
                          queue_size=10)  # Topic for marker pose

    # TODO: this is for subsicriber if u want
    # sub = rospy.Subscriber("other_topic",  # Replace with actual topic name
    #                        SomeMessageType,  # Replace with actual message type
